 ...
 */
final class Version20230208100543 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_item (event_id INT NOT NULL, item_id INT NOT NULL, INDEX IDX_D069B571F7E88B (event_id), INDEX IDX_D069B5126F525E (item_id), PRIMARY KEY(event_id, item_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
