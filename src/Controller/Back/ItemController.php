...
/**
 * @Route("/admin/item", name="app_admin_item_")
 */
class ItemController extends AbstractController
{
    ...
    public function create(Request $request, ItemRepository $itemRepository, MySlugger $mySlugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_item_list', [], Response::HTTP_SEE_OTHER);
        }
    ...
    {
        return $this->render('back/item/read.html.twig', [
            'item' => $item,
        ]);
    }
    ...
    public function update(Request $request, Item $item, ItemRepository $itemRepository): Response
    {
        ...
        return $this->renderForm('back/item/update.html.twig', [
            'item' => $item,
            'form' => $form,
        ]);
    }
