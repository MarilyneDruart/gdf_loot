...
class SearchController extends AbstractController
{
    ...
    {
        return $this->render('back/search/index.html.twig', [
    ...
    public function itemSearchBar(): Response
    {
        $form = $this->createFormBuilder()
            ...
            ->getForm();
        return $this->render('back/search/searchBar.html.twig', [
    ...
    public function handleItemSearch(Request $request, ItemRepository $itemRepository)
    {
        ...
        return $this->render('back/search/item_index.html.twig', [
            'items' => $items,
        ]);
    }
    ...
    public function handlePlayerSearch(Request $request, PlayerRepository $playerRepository)
    {
        ...
        return $this->render('back/search/player_index.html.twig', [
            'players' => $players,
        ]);
    }
}
